...
const App = () => {
  const layoutxl = [
    ...
    { i: "c", x: 6, y: 0, w: 6, h: 17 },
    { i: "d", x: 0, y: 0, w: 4, h: 14 },
    { i: "f", x: 6, y: 0, w: 4, h: 14 },
  ...
  const layoutlg = [
    ...
    { i: "c", x: 6, y: 0, w: 6, h: 14, maxH: 18 },
    { i: "d", x: 0, y: 0, w: 5, h: 14 },
    { i: "f", x: 6, y: 0, w: 5, h: 14 },
  ...
  const layoutmd = [
    ...
    { i: "c", x: 5, y: 0, w: 5, h: 12, maxH: 18 },
    { i: "d", x: 0, y: 0, w: 5, h: 14 },
    { i: "f", x: 5, y: 0, w: 5, h: 12 },
  ...
  const layoutxs = [
    ...
    { i: "f", x: 0, y: 0, w: 4, h: 13 },
    { i: "e", x: 0, y: 0, w: 4, h: 13 }
  ];
  const layouts = {
    xl: layoutxl,
    lg: layoutlg,
  ...
  return (
    <div className="App">
      <ResponsiveGridLayout
        ...
        layouts={layouts}
        rowHeight={30}
        breakpoints={{ xl: 1420, lg: 1179, md: 707, sm: 589, xs: 480, xxs: 0 }}
      ...
      >
        ...
        <div key="a">
          {/* <Charts.WorldOverviewTable /> */}
          <Charts.CurrentInfoByAreasTable />
        </div>
        <div key="b">
          <Charts.WorldCasesGrowthFactorLineChart />
        </div>
        <div key="c">
          <Charts.ConfirmedCasesInAreasLineChart />
          {/* <Charts.ConfirmedCasesChinaVsWorldLineChart /> */}
        </div>
        <div key="d">
          <Charts.WorldRecoveryProgressBarChart />
        </div>
        <div key="e">
          <Charts.CasesGrowthFactorInAnAreaLineChart area="India" />
          {/* <Charts.DeathRateInAnAreaLineChart area="United States of America" /> */}
        </div>
        {/* <div key="f"> */}
        {/*   <Charts.DeathRateByAgeGroupBarChart /> */}
        {/* </div> */}
      </ResponsiveGridLayout>
    </div>
  );
